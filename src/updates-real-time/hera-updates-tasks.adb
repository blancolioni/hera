...
package body Hera.Updates.Tasks is

   package Signal_Holders is
     new Ada.Containers.Indefinite_Holders
       (Hera.Signals.Signal_Type, Hera.Signals."=");
   ...
   begin
      loop
         select
            accept Broadcast (Signal : Hera.Signals.Signal_Type) do
               Signal_Holder.Replace_Element (Signal);
            end Broadcast;
            Hera.UI.Broadcast (Signal_Holder.Element);
         or
            accept Stop;
            exit;
         or
            ...
            or
               ...
               begin
                  ...
                  Broadcast_Task.Broadcast
                    (Hera.UI.Signal_Clock_Tick);

               end;

               declare
                  List  : Update_Lists.List;
                  Clock : constant Hera.Calendar.Time :=
                            Hera.Calendar.Clock;
               begin
