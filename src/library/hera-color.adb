...
with Hera.Color.Table;

package body Hera.Color is

   function Parse_Hex_Color (Spec : String) return Hera_Color;
   ...
   begin
      ...
      elsif Hera.Color.Table.Exists (Item) then
         return Hera.Color.Table.Get (Item);
      else
         return White;
      end if;
   end From_String;
